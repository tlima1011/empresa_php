        ...
        <div class="col">
          ...
          <form action="cadastro_script.php" method="POST"> 
            <div class="form-group"> 
              ...
              <input type="text" class="form-control" placeholder="Informe nome completo" name="nome" required> 
            </div>
            <div class="form-group"> 
              <label for="endereco">Endereço</label>
              <input type="text" class="form-control" placeholder="Informe endereço completo" name="endereco"> 
            </div>
            <div class="form-group"> 
